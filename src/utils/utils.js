...
export function getHandleValueTouch(event) {
  var touch = event.changedTouches[0]
  var parentElement = document.getElementById('gradient-bar-progress')
  var rect = parentElement.getBoundingClientRect()
  var posX = touch.clientX - rect.left // Use clientX and rect.left
  var percentage = (posX / parentElement.offsetWidth) * 100
